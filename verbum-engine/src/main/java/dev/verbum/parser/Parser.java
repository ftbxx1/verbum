...
public final class Parser {
    ...
    static {
        String[][] phrases = {
            ...
            // slots & equipment
            {"set slot", "setslot"}, {"put in slot", "put"}, {"put into slot", "put"},
            {"set item amount", "setitemamount"}, {"set amount of", "setitemamount"}, {"set stack size", "setitemamount"},
            {"set unbreakable", "setunbreakable"}, {"make unbreakable", "setunbreakable"},
            {"set item unbreakable", "setunbreakable"},
            {"set skull owner", "setskullowner"}, {"set player skull", "setskullowner"},
            {"set attack speed", "setattackspeed"}, {"set saturation", "setsaturation"}, {"set air", "setair"},
            {"set flying to", "setflying"},
            {"set gliding", "setgliding"}, {"make glide", "setgliding"}, {"make gliding", "setgliding"},
            {"set armor slot", "setarmorslot"},
            {"set display name", "setdisplayname"}, {"set player display name", "setdisplayname"},
            {"set list name", "setlistname"}, {"set nametag", "setlistname"},
            {"set glow color", "setglowcolor"}, {"set glow colour", "setglowcolor"}, {"set glowing color", "setglowcolor"},
            {"set tab list header", "settablistheader"}, {"set tab header", "settablistheader"},
            {"set respawn point", "setrespawn"}, {"set player respawn", "setrespawn"}, {"set bed spawn", "setbedspawn"},
            {"clear effects", "cleareffects"}, {"clear all effects", "cleareffects"},
            {"remove all effects", "removealleffects"}, {"remove every effect", "removealleffects"},
            {"set food level", "setfoodlevel"}, {"set hunger level", "setfoodlevel"},
            {"feed fully", "feedfull"}, {"feed to full", "feedfull"}, {"fill hunger", "feedfull"},
            {"broadcast title", "broadcasttitle"}, {"broadcast actionbar", "broadcastactionbar"},
            {"broadcast toast", "broadcasttoast"}, {"broadcast sound", "broadcastsound"},
            {"play sound for all", "broadcastsound"},
            {"silence sounds", "stopsounds"}, {"silence all sounds", "stopsounds"}, {"mute sounds", "stopsounds"},
            {"mute all sounds", "stopsounds"}, {"kill all sounds", "stopsounds"},
            {"play music disc", "musicdisc"}, {"play a music disc", "musicdisc"}, {"play record", "musicdisc"},
            {"drop experience", "dropexperience"}, {"drop xp", "dropexperience"}, {"spawn experience", "dropexperience"},
            {"drop item at", "dropat"}, {"drop an item at", "dropat"},
            {"lightning at", "lightningat"}, {"strike lightning at", "lightningat"},
